...
[![版本](https://img.shields.io/badge/版本-1.0.5-blue.svg)](https://github.com/ARC-Minecraft/EndstoneMC-ARC-Sign-Shop-Plugin)
...
将 `endstone_arc_sign_shop-1.0.5-*.whl` 放入服务器 `plugins` 目录后重启。数据目录：`plugins/ARCSignShop/`。
